...
import { configSchema, type HighliConfig } from "./config-schema.js";

export type { HighliConfig } from "./config-schema.js";
...
export function getConfig(): HighliConfig {
  ...
  return configSchema.parse({
    ai: {
      ...
      model: process.env.AI_MODEL ?? raw.ai?.model ?? "claude-sonnet-4-5",
    },
    github: raw.github,
    slack: raw.slack,
    linear: raw.linear,
