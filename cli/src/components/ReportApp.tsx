...
import { getActiveSourceNames } from "@highli/sources";
import { generate, type GenerateMode } from "../report/generate.js";
import { saveDocument, type DocumentKind } from "@highli/core/documents";
...
const MODE_CONFIG: Record<GenerateMode, { title: string; kind: DocumentKind }> = {
  report: { title: "insights report", kind: "report" },
  brag: { title: "brag document", kind: "brag" },
  "brag-amend": { title: "brag document (amend)", kind: "brag" },
  "peer-collab": { title: "peer collaboration log", kind: "peer-collab" },
};
