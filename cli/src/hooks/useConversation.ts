...
import { getModel, buildSystemPrompt } from "@highli/core/ai";
import type { ChatMessage, ActiveTool } from "@highli/core/ai";
    ...
    async (content: string, screenshotPath?: string) => {
      ...
      try {
        const result = streamText({
          model: getModel(),
          system:
            systemPromptRef.current ?? buildSystemPrompt(allSources, timeframe),
